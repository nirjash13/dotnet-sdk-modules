...
/** Simple imperative toast state — no external state library required. */
interface ToastItem {
  id: string;
  title?: string;
  description?: string;
...
function dispatch(item: Omit<ToastItem, "id">): void {
...
function useToasts(): ToastItem[] {
  const [items, setItems] = React.useState<ToastItem[]>(toastList);
  React.useEffect(() => {
