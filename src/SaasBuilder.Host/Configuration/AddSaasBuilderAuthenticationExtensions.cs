...
/// </summary>
public static class AddSaasBuilderAuthenticationExtensions
{
    /// <summary>
    ...
    /// The Identity module and SaasBuilder.Host run in the same process. The JwtBearer middleware
    ...
    public static IServiceCollection AddSaasBuilderAuthentication(
