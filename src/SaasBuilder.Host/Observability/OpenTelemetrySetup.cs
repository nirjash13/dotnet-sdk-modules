...
/// <c>SaasBuilderHostExtensions.AddSaasBuilderHost</c> via <c>builder.Host.UseSerilog()</c>.
/// </summary>
internal static class OpenTelemetrySetup
{
    ...
    /// </list>
    /// </remarks>
    internal static IServiceCollection AddSaasBuilderObservability(
