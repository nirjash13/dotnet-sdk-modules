...
/// </para>
/// </remarks>
internal static class SaasBuilderMeters
{
    /// <summary>The root <see cref="Meter"/> for all chassis host instruments.</summary>
    public static readonly Meter Meter = new Meter("SaasBuilder.Host", "0.1.0");
    ...
    /// <c>SaasBuilderMeters.SagaDurationSeconds.Record(elapsed.TotalSeconds, tagList)</c>.
    /// </remarks>
