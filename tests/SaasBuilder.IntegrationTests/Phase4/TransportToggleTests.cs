...
/// - If the toggle logic in SaasBuilderHostExtensions is broken so "bus" still registers
///   AddSaasBuilderMediator, the test still passes (consumer code is transport-agnostic), which
