...
namespace SaasBuilder.IntegrationTests.Phase3;
...
/// - If the EF Core global query filter is removed from SaasBuilderDbContext, the Tenant-B
...
public sealed class LedgerIdorTests : IAsyncLifetime
{
    ...
    private HttpClient CreateClientFor(Guid tenantId, Guid userId)
    {
        ...
        string token = Phase2.SaasBuilderHostFixture.MintToken(tenantId, userId);
    ...
    /// <summary>
    /// WebApplicationFactory that configures the SaasBuilder host with a Testcontainers
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureAppConfiguration((_, config) =>
            {
                config.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["ConnectionStrings:SaasBuilder"] = _connectionString,
                    ["ConnectionStrings:DefaultConnection"] = _connectionString,
                    ["Identity:SeedDevClient"] = "true",
                    ["Identity:AllowInsecureMetadata"] = "true",
                    ["Identity:Authority"] = Phase2.SaasBuilderHostFixture.TestIssuer,
                    ["Identity:Audience"] = Phase2.SaasBuilderHostFixture.TestAudience,
            ...
            builder.ConfigureTestServices(services =>
            {
                ...
                services.PostConfigureAll<JwtBearerOptions>(options =>
                {
                    ...
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = Phase2.SaasBuilderHostFixture.SigningKey,
                        ValidateIssuer = true,
                        ValidIssuer = Phase2.SaasBuilderHostFixture.TestIssuer,
                        ValidateAudience = true,
                        ValidAudience = Phase2.SaasBuilderHostFixture.TestAudience,
