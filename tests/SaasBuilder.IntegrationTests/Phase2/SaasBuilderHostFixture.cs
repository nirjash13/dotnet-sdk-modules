...
/// <summary>
/// Shared fixture that boots SaasBuilder.Host in-process against a Testcontainers Postgres
...
/// </remarks>
public sealed class SaasBuilderHostFixture : IAsyncLifetime
{
    ...
    /// </summary>
    private sealed class SaasBuilderWebApplicationFactory : WebApplicationFactory<Program>
    {
        private readonly string _connectionString;
        private readonly RsaSecurityKey _signingKey;

        public SaasBuilderWebApplicationFactory(string connectionString, RsaSecurityKey signingKey)
        {
