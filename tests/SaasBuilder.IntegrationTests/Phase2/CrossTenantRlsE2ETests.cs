...
using SaasBuilder.IntegrationTests.Phase2.TestModules;
using SaasBuilder.Sample.Host;
using SaasBuilder.SharedKernel.Abstractions;
using Testcontainers.PostgreSql;
using Xunit;

namespace SaasBuilder.IntegrationTests.Phase2;
...
/// - If <see cref="SaasBuilder.Persistence.SaasBuilderDbContext"/>'s global query filter is removed,
...
public sealed class CrossTenantRlsE2ETests : IAsyncLifetime
{
    ...
    private HttpClient CreateClientFor(Guid tenantId, Guid userId)
    {
        ...
        string token = SaasBuilderHostFixture.MintToken(tenantId, userId);
    ...
    /// This causes <c>UseSaasBuilderPipeline</c> to call <c>testModule.Configure(endpoints)</c>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureAppConfiguration((_, config) =>
            {
                config.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["Identity:Authority"] = SaasBuilderHostFixture.TestIssuer,
                    ["Identity:Audience"] = SaasBuilderHostFixture.TestAudience,
                });
            });
            ...
            builder.ConfigureTestServices(services =>
            {
                ...
                //    instance by AddSaasBuilderHost), wrap it, and re-register.
                ...
                services.PostConfigureAll<JwtBearerOptions>(options =>
                {
                    ...
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = SaasBuilderHostFixture.SigningKey,
                        ValidateIssuer = true,
                        ValidIssuer = SaasBuilderHostFixture.TestIssuer,
                        ValidateAudience = true,
                        ValidAudience = SaasBuilderHostFixture.TestAudience,
