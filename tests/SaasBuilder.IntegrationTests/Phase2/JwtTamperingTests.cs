...
/// <see cref="SaasBuilder.Host.Configuration.AddSaasBuilderAuthenticationExtensions"/> that
...
public sealed class JwtTamperingTests : IClassFixture<SaasBuilderHostFixture>
{
    private readonly SaasBuilderHostFixture _fixture;

    public JwtTamperingTests(SaasBuilderHostFixture fixture)
    {
    ...
    public async Task ProtectedEndpoint_WithValidToken_Returns200()
    {
        ...
        string token = SaasBuilderHostFixture.MintToken(
            tenantId: SaasBuilderHostFixture.TenantA,
            userId: SaasBuilderHostFixture.UserA);
    ...
    public async Task TokenSignedWithDifferentKey_Returns401()
    {
        ...
        string tamperedToken = SaasBuilderHostFixture.MintToken(
            tenantId: SaasBuilderHostFixture.TenantA,
            userId: SaasBuilderHostFixture.UserA,
    ...
    public async Task ExpiredToken_Returns401()
    {
        ...
        string expiredToken = SaasBuilderHostFixture.MintToken(
            tenantId: SaasBuilderHostFixture.TenantA,
            userId: SaasBuilderHostFixture.UserA,
    ...
    public async Task ValidTokenWithNoTenantIdClaim_Returns401WithMissingTenantCode()
    {
        ...
        var tokenDescriptor = new SecurityTokenDescriptor
        {
            Subject = new System.Security.Claims.ClaimsIdentity(
                new[]
                {
                    new System.Security.Claims.Claim("sub", SaasBuilderHostFixture.UserA.ToString()),
                    // Intentionally omit tenant_id claim.
                }),
            Issuer = SaasBuilderHostFixture.TestIssuer,
            Audience = SaasBuilderHostFixture.TestAudience,
            NotBefore = DateTime.UtcNow.AddMinutes(-1),
            Expires = DateTime.UtcNow.AddHours(1),
            SigningCredentials = new SigningCredentials(
                SaasBuilderHostFixture.SigningKey,
