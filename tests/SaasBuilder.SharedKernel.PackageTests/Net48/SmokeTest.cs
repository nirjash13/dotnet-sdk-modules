// SaasBuilder.SharedKernel net48 smoke test.
// Build success = the SharedKernel package's netstandard2.0 facet is consumable from .NET Framework 4.8.

using System;
using SaasBuilder.SharedKernel.Abstractions;
using SaasBuilder.SharedKernel.Contracts;

namespace SaasBuilder.SharedKernel.PackageTests.Net48;
...
internal static class SmokeTest
{
    internal static int Main()
    {
        ...
        Console.WriteLine("net48 smoke test passed.");
        return 0;
    }
}
