...
dotnet user-secrets set "ConnectionStrings:Default" \
  "Host=localhost;Port=5432;Database=b2bsample;Username=postgres;Password=<your-password>"
```

Or via an **environment variable** (works in any environment):

```bash
export ConnectionStrings__Default="Host=localhost;Port=5432;Database=b2bsample;Username=postgres;Password=<your-password>"
```
